    ...
    <div className="min-h-screen flex items-center justify-center p-5">
      <div className="glass-card w-full max-w-sm p-9">
        <div className="flex items-center gap-2.5 mb-6">
          <div className="w-9 h-9 rounded-[10px] bg-grad-brand flex items-center justify-center font-display font-bold text-white">
            P
          </div>
        ...
        <p className="text-sm text-ink-dim mb-6">
          Free — track progress across 400+ topics.
        </p>
        ...
        <form onSubmit={handleRegister} className="space-y-3.5">
          ...
          {info && (
            <p className="text-xs text-cyan">{info}</p>
          )}
        ...
        <div className="flex items-center gap-2.5 my-4 text-ink-faint text-[11px]">
          <span className="flex-1 h-px bg-glass-brd"></span>
          OR
          <span className="flex-1 h-px bg-glass-brd"></span>
        </div>
        ...
        <p className="text-center text-sm text-ink-dim mt-5">
          ...
          <Link href="/login" className="text-indig font-semibold">
            Log in
          </Link>
        </p>
      </div>
